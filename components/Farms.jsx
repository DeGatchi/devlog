                ...
                <DetailsContainer>
                    <DetailsWrapper>
                        <FunctionBox>
                            ...
                            <SubmitButton primaryColour='#45b7da' type="Submit">Stake</SubmitButton>
                        </FunctionBox>
                        <FunctionBox>
                            <Input name="unstake" type="number" placeholder="0.0" />
                            <SubmitButton primaryColour='#e63d27' type="Submit">Unstake</SubmitButton>
                        </FunctionBox>
                    </DetailsWrapper>
                </DetailsContainer>
            ) : null}
...
const SubmitButton = styled.button`
  ...
  background: ${({ primaryColour }) =>
        primaryColour ? primaryColour : "white"};
  color: black;

  &:hover {
    border-color: ${({ hoverColour }) =>
        hoverColour ? hoverColour : "violet"};
    box-shadow: ${({ hoverColour }) =>
        hoverColour ? `0 0 10px 0 ${hoverColour}` : "0 0 10px 0 violet"};
